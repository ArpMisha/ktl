...
- Botstrap 4
- docker
Это приложение Информационный Каталог. Создано для удоства хранения информация по связанной с корпоративной сетью и информационными системами. 
